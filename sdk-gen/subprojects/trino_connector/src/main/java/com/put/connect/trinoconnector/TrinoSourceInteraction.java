...
public class TrinoSourceInteraction extends RowBasedSourceInteraction<TrinoConnector>
{
    protected TrinoSourceInteraction(TrinoConnector connector, CustomFlightAssetDescriptor asset)
    {
        super();
